//Author : Xiong-Ramdhan-Gumusayak-Ramondo
...
//    ESP_LOGD(TAG, "free heap size is %d, maxminu %d", esp_get_free_heap_size(), esp_get_minimum_free_heap_size());
    ...
    case MQTT_EVENT_DATA:
        ...
        // here is how you deal with received message data from suscribed topic
...
static void mqtt5_app_start(void)
{
    ...
    // Here is how you subscribe to a topic
    ...
    while (1) {
        ...
        // Here is how you publish data to a topic (QOS set to 0)
...
//    ESP_LOGI(TAG, "[APP] Free memory: %d bytes", esp_get_free_heap_size());
 ...
 // xTaskCreate(temp_task,"temp_task", 4096, NULL, 5, NULL);
  ...
  xTaskCreate(mqtt5_app_start, "mqtt5_app_start", 1024*8, NULL, 1, NULL);
