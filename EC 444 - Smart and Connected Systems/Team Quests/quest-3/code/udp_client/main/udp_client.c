//Team6-Xiong-Ramdhan-Gumusayak-Ramondo  Date:10/26/23
...
static void test_alpha_display() {
    ...
    while (1) {
        if(clock_timer_state==0){
            ...
            displaybuffer[3]=alphafonttable[place+48];
            displaybuffer[2]=0b0001001000000000;
            displaybuffer[1]=0b0001001000001111;//d
            displaybuffer[0]=0b0001001000001001;//I
            size=0;
            for(int ii=0;ii<4;ii++){
                if (arrayDisplayed[ii]!='\0'){
                size++;
